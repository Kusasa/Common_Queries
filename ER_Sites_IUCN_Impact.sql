...
CREATE MATERIALIZED VIEW iucn_animals
...
CREATE INDEX iucn_mammals_geom_idx ON iucn_animals USING gist (geom);
CREATE INDEX iucn_mammals_category_idx name ON iucn_animals USING HASH (category);
